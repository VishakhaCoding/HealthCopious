...
public void Birthdate() throws MalformedURLException, InterruptedException {
	...
	Thread.sleep(5000);
	 List<WebElement> BirthYear =driver.findElements(By.xpath(
				"//*[@text='2024']"));
	 BirthYear.get(0).click();
	
	  Thread.sleep(5000);
	  
	  System.out.println("Before scrolling ....");
		driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\"2000\").instance(0))"));
		Thread.sleep(10000);
		List<WebElement> BirthYear1 =driver.findElements(By.xpath(
				"//*[@text='2000']"));
		BirthYear1.get(0).click();
