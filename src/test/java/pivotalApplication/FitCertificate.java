...
public class FitCertificate extends AppiumServerStart{
...
//			driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollIntoView(new UiSelector().text(\"Link Patient to Doctor")).click();
	...
	public void Speciality() throws InterruptedException, IndexOutOfBoundsException {
		Thread.sleep(2000);
		List<WebElement> Speciality =  driver.findElements(By.xpath("//*[@text='Speciality']"));
		
		Speciality.get(0).click();
	...
	public void Preview() throws InterruptedException, IndexOutOfBoundsException {
		Thread.sleep(2000);
		List<WebElement> Preview =  driver.findElements(By.xpath("//*[@text='Preview']"));
