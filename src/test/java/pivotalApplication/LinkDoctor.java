...
public class LinkDoctor extends AppiumServerStart{
...
//			driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollIntoView(new UiSelector().text(\"Link Patient to Doctor")).click();
	...
	/*
	 * @Test(priority = 11) public void Valid() throws InterruptedException,
	 * IndexOutOfBoundsException { //Thread.sleep(5000); //Thread.sleep(5000);
	 * WebElement LinkMsge = driver.findElement(By.xpath(
	 * "/hierarchy/android.widget.FrameLayout/android.view.View[4]"));
	 * //submit.click();
	 * 
	 * 
	 * 
	 * 
	 * String a=LinkMsge.getText(); System.out.println(a); String
	 * Actualmsge="Linked patient to doctor"; Assert.assertEquals(a, Actualmsge);
	 * 
	 * Thread.sleep(20000); }
	 */
