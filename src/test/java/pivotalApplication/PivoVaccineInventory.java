...
public class PivoVaccineInventory extends AppiumServerStart{
	AppiumDriver driver;
...
public void menu() throws InterruptedException {
	...
	Thread.sleep(2000);
	  ...
	  List<WebElement> menu =  driver.findElements(By.xpath("//*[@text='Menu']"));
	  menu.get(0).click();
	  Thread.sleep(2000);

}
@Test(priority = 7)
public void VccineInventory() throws InterruptedException {
	
	Thread.sleep(2000);
	
	  List<WebElement> VccineInventory =  driver.findElements(By.xpath("//*[@text='Vaccine Inventory']"));
	  VccineInventory.get(0).click();
	  Thread.sleep(2000);

}
@Test(priority = 8)
public void NewStock() throws InterruptedException {
	
	Thread.sleep(2000);
	
	  List<WebElement> NewStock =  driver.findElements(By.xpath("//*[@text='+ New Stock']"));
	  NewStock.get(0).click();
	  Thread.sleep(2000);
