...
public class PriorityAppointment extends AppiumServerStart{
...
@Test(priority=5) public void Search() throws InterruptedException {
	...
	WebElement SearchIcon = driver.findElement(By.xpath(
		  ...
		  Thread.sleep(2000); WebElement SearchIcon1= driver.findElement(By.xpath(
		  "//android.view.ViewGroup[@content-desc=\"search_icon\"]/android.widget.TextView"
		  )); SearchIcon1.click(); Thread.sleep(2000); 
