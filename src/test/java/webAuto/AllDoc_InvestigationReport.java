...
public class AllDoc_InvestigationReport {
	...
	public static String OTP1="/html/body/app-root/app-signin/div/div/div/div/div[1]/div/div/section/div/div[3]/div/input[1]"; 
       ...
       public static String ClickReport="//*[text()=' Reports ']";
	   public static void waitForVisibilityOf(By by) {
		...
		public void searchOpt() throws InterruptedException {
		  ...
		  @Test(priority = 8) public void AllDocuments() throws InterruptedException {
			  ...
			  waitForVisibilityOf(By.xpath(ClickReport));
			  driver.findElement(By.xpath(ClickReport));
			  highlightElement(By.xpath(ClickReport));
			  clickUsingJavaScript(By.xpath(ClickReport));
			  
			  waitForVisibilityOf(By.xpath(ViewInvestigationReport));
			  driver.findElement(By.xpath(ViewInvestigationReport));
			  highlightElement(By.xpath(ViewInvestigationReport));
			  clickUsingJavaScript(By.xpath(ViewInvestigationReport));
			  Thread.sleep(15000);
			  waitForVisibilityOf(By.xpath(InvestigationReportClose));
			  driver.findElement(By.xpath(InvestigationReportClose));
			  highlightElement(By.xpath(InvestigationReportClose));
			  clickUsingJavaScript(By.xpath(InvestigationReportClose));
		  }
