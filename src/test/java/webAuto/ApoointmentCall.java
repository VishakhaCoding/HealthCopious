...
public class ApoointmentCall {
	...
	public static String SelectSlot="/html/body/div[2]/div[4]/div/mat-dialog-container/div/div[2]/form[2]/div/div/div/div[27]/div";
	public static String ScheduleVideoCall="/html/body/div[2]/div[2]/div/mat-dialog-container/div/div[2]/div[2]/div[3]/div[2]/div/div/label/input";
	...
	public void AddNewAppointment() throws InterruptedException {
		...
		Thread.sleep(5000);
		waitForVisibilityOf(By.xpath(ScheduleVideoCall));
		driver.findElement(By.xpath(ScheduleVideoCall));
		highlightElement(By.xpath(ScheduleVideoCall));
		clickUsingJavaScript(By.xpath(ScheduleVideoCall));
