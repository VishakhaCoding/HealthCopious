...
public static WebDriver driver; static String doctorLoginLink = "/html/body/app-root/app-home-page/div/div/div/header[2]/div/div[4]/button";
		...
		public static String SelectSlot="/html/body/div[2]/div[4]/div/mat-dialog-container/div/div[2]/form[2]/div/div/div/div[32]/div";
		...
		public void AddNewAppointment() throws InterruptedException {
			...
			Thread.sleep(15000);
			waitForVisibilityOf(By.xpath(CancelAppointment));
			driver.findElement(By.xpath(CancelAppointment));
			highlightElement(By.xpath(CancelAppointment));
			clickUsingJavaScript(By.xpath(CancelAppointment));
			
			waitForVisibilityOf(By.xpath(CancelYes));
			driver.findElement(By.xpath(CancelYes));
			highlightElement(By.xpath(CancelYes));
			clickUsingJavaScript(By.xpath(CancelYes));
