...
public class Domo_pract extends TestBase {
	 ...
	 LoginPage loginP;
		 ...
		 * InterruptedException { loginP.clickOnDoctorLink();
		 * loginP.enterMobileNumber("9665002440"); loginP.sendOTP();
		 * System.out.println("vvv"+loginP.getValidationMsg());
		 * Assert.assertEquals("Please Enter 10 Digit of Phone",
		 * loginP.getValidationMsg()); //Thread.sleep(20000); //loginPage.verifyOtp();
	   ...
	   @Test(priority = 1)
		...
		loginP.clickOnDoctorLink();
		loginP.enterMobileNumber("9665002440");
		loginP.sendOTP();
		Thread.sleep(20000);
		loginP.verifyOtp();
		System.out.println(homePage.getWelcomeUserN());
