...
public class Edit_PatientProfile {
    ...
    public static String firstName="//*[text()='Profile']//following::input[5]";
    public static String middleName="//*[text()='Profile']//following::input[6]";
    public static String lastName="//*[text()='Profile']//following::input[7]";
    ...
    public static String selectDelivery="//*[text()='Antenetal & Birth History']//following::span[19]";
   ...
   // public static String AddmedicalConditions="//*[text()='Add Medical Conditions']";
    ...
    public static String healthNext="//*[text()='Health Profile']//following::button[19]";
