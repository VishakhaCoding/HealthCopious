...
public class Immunization_BasicRecord {
	...
	public static String ClickCalender = "//*[text()='Special Situation Vaccines']//following::img";
	...
	public void searchBar() {
		...
		driver.findElement(By.xpath(searchBar)).sendKeys("SysDate");
