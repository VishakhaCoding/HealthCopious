...
public class New_PediatricOverView {
	...
	public static String SaveNotes="//*[text()='Notes']/following::div[1]";
	   ...
	   public static String mobileNumber="/html/body/app-root/app-signin/div/div/div/div/div[1]/div/div/section/div/div/form/div[2]/input";
	    ...
	    public static String success="//*[text()='Success']//following::div[9]";
	    ...
	    public static String SelectDate="//*[text()=' 1 ']";		
		   ...
		   public static String OTP6="/html/body/app-root/app-signin/div/div/div/div/div[1]/div/div/section/div/div[3]/div/input[6]"; 
			    ...
			    public static String FamilyMedicalHistory = "//*[text()='Family Profile']//following::input[23]";
		  		...
		  		public static String AdvitalHeihgt = "//*[text()='Vitals']//following::input[2]";
		  		public static String AdheadCircumferance = "//*[text()='Vitals']//following::input[3]";

		  		public static String AdBpAndHeart = "//*[text()='BP & Heart']";
		  		public static String AdBPSys = "//*[text()='BP & Heart']//following::input[1]";
		  		public static String AdBPDia = "//*[text()='BP & Heart']//following::input[2]";
		  		public static String AdheartRate = "//*[text()='BP & Heart']//following::input[3]";
		  		public static String Adpulse = "//*[text()='BP & Heart']//following::input[4]";
		  		
		  		public static String AdBloodAndAnalysis = "//*[text()='Blood Analysis(Sugar)	']";
		  		public static String AdHaemoglobin = "//*[text()='Blood Analysis(Sugar)	']//following::input[1]";
		  		public static String AdBloodSugarRandom = "//*[text()='Blood Analysis(Sugar)	']//following::input[2]";
		  		public static String AdBloodSugarF = "//*[text()='Blood Analysis(Sugar)	']//following::input[3]";
		  		public static String AdBloodSugarPP = "//*[text()='Blood Analysis(Sugar)	']//following::input[4]";
		  		public static String AdBlood = "//*[text()='Blood Analysis(Sugar)	']//following::input[5]";
		  		
		  		public static String AdLipidProfile = "//*[text()='Lipid Profile']";
		  		public static String AdCholestrerolHDL = "//*[text()='Lipid Profile']//following::input[1]";
		  		public static String AdCholestrerolLDL = "//*[text()='Lipid Profile']//following::input[2]";
		  		public static String AdtotalCholesterol = "//*[text()='Lipid Profile']//following::input[3]";
		  		public static String AdTriglycerides = "//*[text()='Lipid Profile']//following::input[4]";
		  		
		  		public static String AdRxCC = "//*[text()='Vitals']//following::input[4]";
		  		public static String Adtemperature = "//*[text()='Vitals']//following::input[5]";
		  		public static String AdSPO2 = "//*[text()='Vitals']//following::input[6]";
