...
public class Appointment {
	...
	public static String NoSlotError="/html/body/app-root/app-layout/ng-sidebar-container/div/div/div/app-home-dashboard/div[2]/div[2]/div[1]/app-patient/p-toast/div/p-toastitem/div/div/div/div[2]/div[2]";
	...
	public void AddNewAppointment() throws InterruptedException {
		...
		clickUsingJavaScript(By.xpath(BookAppointment));
		  ...
		  waitForVisibilityOf(By.xpath(NoSlotError));
		  highlightElement(By.xpath(NoSlotError));
		  String actualMsg =driver.findElement(By.xpath(NoSlotError)).getText();
		  System.out.println("actual Msg :"+actualMsg);
		  Object errorMessage = "No slot selected";
