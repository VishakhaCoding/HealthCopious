...
public class MovePatientToEndQ {
	...
	/*
	 * @Test(priority = 9) public void searchBar1() {
	 * waitForVisibilityOf(By.xpath(searchBar));
	 ...
	 * clickUsingJavaScript(By.xpath(searchBar)); }
	 * 
	 * @Test(priority = 10) public void searchOpt1() throws InterruptedException {
	...
	@Test(priority = 13)
	public void JoinOk1() throws InterruptedException {
		Thread.sleep(3000);
		waitForVisibilityOf(By.xpath(JoinOk));
		driver.findElement(By.xpath(JoinOk));
		highlightElement(By.xpath(JoinOk));
