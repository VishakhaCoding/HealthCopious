...
public class DeleteFavouriteMedicineQ {
public static WebDriver driver;
	...
	public static String DeleteMed="/html/body/app-root/app-layout/ng-sidebar-container/div/div/div/app-favourite-management/div/div[2]/div[3]/div/div[2]/img";
	public static String DeleteOption="//*[text()='Are you sure you want to delete selected medicine?']/ following::button[2]";
	public static String DeleteFavouriteMed="/html/body/app-root/app-layout/ng-sidebar-container/div/div/div/app-favourite-management/div/div[2]/div[2]/div[2]/div[1]/button/mat-icon";
	public static String YesDelete="/html/body/div[4]/div[2]/div/mat-dialog-container/div[2]/button[2]";
	...
	public void verifyButton() throws InterruptedException {
		...
		driver.findElement(By.xpath(FavouriteName)).sendKeys("Delete");
		...
		waitForVisibilityOf(By.xpath(DeleteMed));
		driver.findElement(By.xpath(DeleteMed));
		highlightElement(By.xpath(DeleteMed));
		clickUsingJavaScript(By.xpath(DeleteMed));
		
		waitForVisibilityOf(By.xpath(DeleteOption));
		...
		Thread.sleep(5000);
		waitForVisibilityOf(By.xpath(DeleteFavouriteMed));
		driver.findElement(By.xpath(DeleteFavouriteMed));
		highlightElement(By.xpath(DeleteFavouriteMed));
		clickUsingJavaScript(By.xpath(DeleteFavouriteMed));
		
		Thread.sleep(5000);
		waitForVisibilityOf(By.xpath(YesDelete));
		driver.findElement(By.xpath(YesDelete));
		highlightElement(By.xpath(YesDelete));
		clickUsingJavaScript(By.xpath(YesDelete));
